                ...
                <div className=" w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        {News.slice(0, visibleCount).map((item: NewsProp, index) => (
                            <Link href={`/fullnews/${item.id}`} key={index} className="group flex flex-row items-start py-8 border-b gap-[48px] transition-all duration-300 ease-in-out hover:pl-12 hover:bg-[#808080] cursor-pointer px-4">
