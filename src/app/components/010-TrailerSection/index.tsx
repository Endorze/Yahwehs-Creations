    ...
    return (
        ...
        >
            ...
            <img
                ...
                alt="Gradient Line"
                className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-md object-cover pointer-events-none z-0"
            />
            ...
            <div className="relative z-10 max-w-4xl w-full">
                ...
                <div className="text-left">
                    <H2Title text="HOW CAN WE CERTAIN THAT ANGELS MEAN NO HARM" size="45px" />
